export default function StartCareeIcon () {
    return (
        <svg width="66" height="72" viewBox="0 0 66 72" fill="none" xmlns="http://www.w3.org/2000/svg">
            ...
            <path d="M26.6799 44.75H37.9399" stroke="#0D1117" stroke-width="2" stroke-linecap="round"
                  stroke-linejoin="round"/>
            <path d="M25.21 36.7002L23.49 38.6602C22.4 39.9002 21.87 41.5402 22.03 43.1902L22.56 48.7502L26.18 43.0502"
                  stroke="#0D1117" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"/>
            <path d="M39.49 36.7002L41.21 38.6602C42.3 39.9002 42.83 41.5402 42.67 43.1902L42.14 48.7502L38.52 43.0502"
                  stroke="#0D1117" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"/>
            <path
                ...
                stroke="#0D1117" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"/>
            <path d="M32.3101 40.3701V44.7501" stroke="#0D1117" stroke-width="2" stroke-linecap="round"
                  stroke-linejoin="round"/>
        </svg>
    )
